...
const CategoryReceiptSection = () => {
   ...
   return (
      <section>
         <h1 className="text-4xl font-semibold leading-relaxed">Browser Our Category</h1>
         <h2 className="text-4xl font-semibold text-[#8BAC3E]">Receipt</h2>
         <div className="flex flex-nowrap gap-x-3 my-12">
            {categoryReceipt.map((item, index) => (
               <div className={`p-7 w-[243px] h-auto rounded-lg ${item.cardColor} text-center flex flex-col justify-center items-center gap-y-3`} key={index}>
         ...
         <div className="flex gap-x-5 justify-end">
            <button className="bg-[#8BAC3E] text-white py-3 px-5 rounded-full relative flex items-center gap-x-2">
