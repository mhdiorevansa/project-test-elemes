...
const HeroSection = () => {
   return (
      <section className="grid grid-cols-2 gap-x-4 my-20 items-center border border-fuchsia-500">
         <div className="space-y-5 border border-yellow-400">
         ...
         <div className="border border-green-500 flex justify-center items-center relative">
            <div className="absolute w-[480px] h-[480px] bg-[#C4C4C4] rounded-full"></div>
            <Image src={"/images/hero-img.png"} className="relative z-10" width={400} height={400} alt="hero-img" />
            <div className="p-5 bg-opacity-65 backdrop-blur-md bg-white rounded-xl absolute z-20 -left-3 -bottom-16 flex gap-x-4">
               <Image src={"/images/hero-img.png"} width={60} height={60} alt="hero-img" />
